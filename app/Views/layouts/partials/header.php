            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown nxl-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                        ...
                        <div class="notifications-item">
                            <img src="/php/mini-ecommerce/public/assets/images/avatar/2.png" alt="" class="rounded me-3 border" />
                ...
                <div class="dropdown nxl-h-item">
                    <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                        <img src="/php/mini-ecommerce/public/assets/images/avatar/13.jpg" alt="user-image" class="img-fluid user-avtar me-0" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                <img src="/php/mini-ecommerce/public/assets/images/avatar/13.jpg" alt="user-image" class="img-fluid user-avtar" />
                                <div>
